...
class ShipsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create ship" do
    assert_difference('Ship.count') do
      post ships_url, params: { ship: { build: @ship.build, country: @ship.country, name: @ship.name, type: @ship.type } }, as: :json
    end
  ...
  test "should update ship" do
    patch ship_url(@ship), params: { ship: { build: @ship.build, country: @ship.country, name: @ship.name, type: @ship.type } }, as: :json
    assert_response 200
  end
