...
class StarsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create star" do
    assert_difference('Star.count') do
      post stars_url, params: { star: { class: @star.class, light-years: @star.light-years, name: @star.name } }, as: :json
    end
  ...
  test "should update star" do
    patch star_url(@star), params: { star: { class: @star.class, light-years: @star.light-years, name: @star.name } }, as: :json
    assert_response 200
  end
